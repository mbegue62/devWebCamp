<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="nombre" name="nombre" value="<?php echo $evento->nombre; ?>" placeholder="Nombre Evento">
    </div>
    <div class="formulario__campo">
        ...
        <textarea class="formulario__input" id="descripcion" name="descripcion" 
         placeholder="Descripción Evento" rows="8"><?php echo $evento->descripcion; ?>
        </textarea>
    </div>
    <div class="formulario__campo">
