<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            DevWebCamp es una conferencia para desarrolladores de todos los niveles, se lleva 
            a cabo de forma presencial y en línea.
            </p>
        </div>
     ...
     <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://web.whatsapp.com//codigoconjuan">
